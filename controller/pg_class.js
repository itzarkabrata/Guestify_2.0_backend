...
export class Pg {
    ...
    static async deletePg(req, res) {
        try {
            ...
            const statusCode = (error instanceof TypeError || error instanceof ReferenceError) ? 400 : 500;
    ...
    static async updatePg(req, res) {
        try {
            ...
            const updatedPg = await PgInfo_Model.findByIdAndUpdate(id, updateData, { new: true, runValidators: true });
