  ...
  static async isLoggedIn(req, res, next) {
    try {
      ...
      if (res_user.length !== 0) {
        ...
        req.user = { id: res_user[0]._id, is_admin: res_user[0].is_admin, email: res_user[0].email, name: res_user[0].first_name + " " + res_user[0].last_name, image_url: res_user[0].image_url };
